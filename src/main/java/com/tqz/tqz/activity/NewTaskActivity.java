...
import com.tqz.tqz.fragment.NewAppFragment;
import com.tqz.tqz.fragment.NewTaskFragment;
...
public class NewTaskActivity extends FragmentActivity {
    ...
    private NewAppFragment mNewAppFragment;
    ...
    public void findById() {
        mVp = (ViewPager) findViewById(R.id.vp_new_task);
        mTabLineIv=(ImageView)findViewById(R.id.iv_new_tab_line);
        mTaskTv=(TextView)findViewById(R.id.new_task_tv);
        mAppTv=(TextView)findViewById(R.id.new_app_tv);
        mBackBtn=(ImageButton)findViewById(R.id.new_back_btn);
    }

    public void init() {
        mNewTaskFragment = new NewTaskFragment();
        mNewAppFragment = new NewAppFragment();
        mFragmentList.add(mNewTaskFragment);
        mFragmentList.add(mNewAppFragment);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event){
        if (keyCode== KeyEvent.KEYCODE_BACK&&event.getRepeatCount()==0){
            //销毁fragment和activity
            mNewTaskFragment.onDestroy();
            mNewAppFragment.onDestroy();
            this.finish();
            return true;
