...
public class YuHuiQuanAdapter extends BaseAdapter {
    ...
    public YuHuiQuanAdapter(Activity activity, ArrayList<HashMap<String, String>> date,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.yu_hui_quan_list_view, parent, false);
        ...
        if ((convertView != null) && convertView.getTag() instanceof ViewHolder) {
            ...
            if (!hashMap.get("YuHuiQuanName").equals("")) {
                //设置listview相关的值
                holder.taskName.setText(hashMap.get("YuHuiQuanName"));
                holder.taskIncome.setText(hashMap.get("YuHuiQuanIncome"));
                //使用imagerLoader对象显示图片的方法，而且双缓存图片
                holder.taskImage.setTag(hashMap.get("YuHuiQuanImageUrl"));
                //图片加载器
                ImageLoader imageLoader = new ImageLoader();
                //设置ImageView填充父容器
                holder.taskImage.setScaleType(ImageView.ScaleType.FIT_XY);
                imageLoader.displayUrlImage(hashMap.get("YuHuiQuanImageUrl"), holder.taskImage, activity);
            }
        }
        return convertView;
    }
