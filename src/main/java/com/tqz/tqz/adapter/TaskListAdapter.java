...
public class TaskListAdapter extends BaseAdapter {
    ...
    public TaskListAdapter(Activity activity, ArrayList<HashMap<String, String>> date,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.task_list_view, parent, false);
        ...
        if ((convertView != null) && convertView.getTag() instanceof ViewHolder) {
            ...
            if (!hashMap.get("TaskName").equals("")) {
                ...
                imageLoader.displayUrlImage(hashMap.get("TaskImageUrl"), holder.taskImage, activity);
            }
        }
        return convertView;
    }
