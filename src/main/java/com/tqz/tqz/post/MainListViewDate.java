...
public class MainListViewDate {
    ...
    private void requestDate() {
        ...
        /**
         *拼装MainListViewAddress：http://localhost/think/www/index.php/
         *Home/MainListView/getDate
         */
        CommonConfig config = new CommonConfig();
        String MainListViewAddress = config.getUrlMainListViewDateFunction();
        //向服务器发送请求
        ...
        if (response == null) {
            ...
            try {
                ...
                JSONArray jsonList = jsonObject.getJSONArray("MainListViewData");
