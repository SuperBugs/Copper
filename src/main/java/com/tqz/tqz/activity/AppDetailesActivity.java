...
public class AppDetailesActivity extends Activity {
    ...
    //private TextView mTaskAddressTextView;
    private LinearLayout mTaskProcessLayout;
    private TextView mShareNumberTV;
    private Button mCopyShareNumberBtn;
    ...
    private int mIvW=500;
    private int mIvH=900;
    private static final String TAG = "AppDetailesActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_detailes);
        activity = this;
    ...
    private void setListener() {
        ...
        mStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(AppDetailesActivity.this, TaskWebViewActivity.class);
                it.putExtra("TaskUrl", mTaskAddressUrl);
                it.putExtra("TaskName", mTaskName);
                startActivity(it);
//                Intent intent = new Intent();
//                intent.setAction("android.intent.action.VIEW");
//                Uri content_url = Uri.parse(mTaskAddressUrl);
...
//                startActivity(intent);
        ...
        mCopyShareNumberBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast toastOne = Toast.makeText(activity, getString(R.string.
                        activity_copy_share_num_hint), Toast.LENGTH_SHORT);
                toastOne.show();
                ClipboardManager cm = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                cm.setText(mShareNumber);
            }
        });
    }
    ...
    private void getViewById() {
        ...
        mShareNumberTV = (TextView) findViewById(R.id.app_share_number);
        mStart = (Button) findViewById(R.id.app_detaile_start);
        mCopyShareNumberBtn = (Button) findViewById(R.id.app_share_copy_btn);
    }
    ...
    private void setView() {
        ImageLoader imageLoader=new ImageLoader();
        imageLoader.displayRoundImage(mTaskImageUrl, mTaskImageView, activity);
        ...
        mShareNumberTV.setText(mShareNumber);//显示邀请码
    }
